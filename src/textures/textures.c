...
void loadTexturesMenu(Textures * textures){
	...
	loadTexture( &(textures->identifiants[TEXTURE_LEVEL_ARKANO_ON]) , 			strcat(strcpy(chemin_menu_copy,chemin_menu),"item/level/arkano/on/1.png"));
	loadTexture( &(textures->identifiants[TEXTURE_LEVEL_ARKANO_OFF]) , 			strcat(strcpy(chemin_menu_copy,chemin_menu),"item/level/arkano/off/1.png"));
